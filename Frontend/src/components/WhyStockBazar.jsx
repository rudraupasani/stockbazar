  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        <div className="w-10 h-0.5 mt-2 rounded-full" style={{ background: "linear-gradient(90deg, #3b82f6, #22c55e)" }} />
      </div>
      ...
      <div className="space-y-3">
        {features.map((item, i) => {
          ...
          return (
            ...
            >
              <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: item.colorBg }}>
